...
namespace RAA_Level2
{
    internal class App : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication app)
        {
            ...
            ButtonDataClass sheetMakerButtonData = new ButtonDataClass("SheetMaker", "Sheet\rMaker", SheetMakerCommand.GetMethod(), Properties.Resources.Red_32, Properties.Resources.Red_16, "Create new Sheets within the project.");
